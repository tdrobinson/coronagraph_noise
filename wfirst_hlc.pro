...
PRO WFIRST_HLC, Ahr, lamhr, alpha, Phi, Rp, Teff, Rs, r, d, Nez, $
  ...
  IF (KEYWORD_SET(emccd_em) OR KEYWORD_SET(emccd_pc)) THEN BEGIN
    ...
    Rc     = 2.e-3     ; clock induced charge (e/pixel/read)
  ENDIF
  ...
  READCOL, fn, lamD, contrast00x,  contrast04x,  contrast08x,  contast16x, /SILENT
  C    = DBLARR(Nlam)
  ...
  ;;;    set HLC throughput    ;;;
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  fn     = './input_data/wfirst_hlc_throughput.dat'
