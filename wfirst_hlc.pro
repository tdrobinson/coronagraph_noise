;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;        WFIRST-AFTA HLC noise model - Tyler D. Robinson
;  inputs:
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
PRO WFIRST_HLC, Ahr, lamhr, alpha, Phi, Rp, Teff, Rs, r, d, Nez, $
  ...
  Tput   = 0.037*0.5 ; system throughput, including polarization loss
  theta  = 0.020     ; angular size of pixel (arcsec)
  IWA    = 2.8       ; inner working angle (lambda/D)
  OWA    = 10.       ; outer working angle (550 nm / D)
  ...
  ;;;   set wavelength grid    ;;;
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  lam  = [0.465,0.565]     ;filter centers (um)
  dlam = [0.0465,0.0565]   ;filter widths (um)
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  fn   = './input_data/wfirst_hlc_contrast.dat'
  READCOL, fn, lamD, contrast00x,  contrast04x,  contrast08x,  contast16x, $
                     contrast00xy, contrast04xy, contrast08xy, contast16xy, /SILENT
  C    = DBLARR(Nlam)
  C    = EXP(INTERPOL(ALOG(contrast04x),lamD,sep)) ;interpolate data to given separation
  
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;;;   set mask throughput    ;;;
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  fn   = './input_data/mask_throughput.dat'
  READCOL, fn, lamD, Tmask, /SILENT
  T    = DBLARR(Nlam)
  T    = INTERPOL(Tmask,lamD,sep) ;interpolate mask throughput to fiven separation
  T    = T*Tput ;multiply mask throughput into total throughput
